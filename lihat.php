...
<div class="apapun">
  <nav class="navbar" style="text-align: center;">
    ...
    <a href="#" class="logo"><img src="images/wasd.png" width="50px" height="50px"></a>
    <h3 align="center" style="color: black">data pengunjung yang hadir</h3>
    <div class="menu" >
      <ul class="list">  
      <li ><a href="kalkulator.html" style="color: black ;">Kalkulator</a></li>
